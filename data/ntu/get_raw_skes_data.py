...
def get_raw_skes_data():
    ...
    for (idx, ske_name) in enumerate(skes_name):
        ...
        raw_skes_data.append(bodies_data)           # bodies_data save each skeletal file
        frames_cnt[idx] = bodies_data['num_frames'] # write each files' frame length
        if (idx + 1) % 1000 == 0:
...
if __name__ == '__main__':
    save_path = './'
    # /media/hao/My Passport/Dataset/NTU Official Dataset/nturgbd_skeletons_s001_to_s017
    skes_path = '/media/hao/My Passport/Dataset/NTU Official Dataset/nturgbd_skeletons_s001_to_s017/nturgb+d_skeletons/'
